...
# universal compile
./compile.py --source ../../output/011D9C15-AF65-4660-B7C9-ECA8676185FE.gui --config ../assets/sample-config.json
```

Generate dataset

```
./generate.py --out-dir ../test_data --config ./assets/sample-config.json --num-train 10000 --num-eval 1000 -d web
```

You might need to install wkhtmltopdf. Click [here](https://github.com/jarrekk/imgkit) for more info.
```
#For Mac OSX
